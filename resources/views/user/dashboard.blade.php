                        ...
                        <ul class="list-group">
                            @foreach($latest_posts as $recent_post)
                                <li class="list-group-item">
                                    ...
                                    <div>
                                        <a href="/profile/{{ $recent_post->user->id }}/{{ $recent_post->user->profile_slug }}">{{ $recent_post->user->character_name or $recent_post->user->name }}</a> posted in <a href="/thread/{{ $recent_post->thread->id }}/{{ $recent_post->thread->slug }}">{{ $recent_post->thread->thread->title  }}</a>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
